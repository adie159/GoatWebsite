...
def user_dashboard():
    ...
    user_pets = [pet for pet in pets if pet['owner_id'] == session['user_id']]
...
def admin_dashboard():
    total_pets = len(pets)
    dogs = len([p for p in pets if p['category'] == 'Dog'])
    cats = len([p for p in pets if p['category'] == 'Cat'])
...
def admin_pets():
    ...
    for pet in pets:
        ...
        pet_with_owner = pet.copy()
        pet_with_owner['owner_name'] = owner['full_name'] if owner else 'Unknown Owner'
        pet_with_owner['owner_email'] = owner['email'] if owner else 'Unknown'
        pet_with_owner['owner_contact'] = owner.get('contact_number', 'N/A') if owner else 'N/A'
        pet_with_owner['owner_address'] = owner.get('address', 'N/A') if owner else 'N/A'
        pets_with_owners.append(pet_with_owner)
